...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { descricao: @produto.descricao, foto: @produto.foto, marca: @produto.marca, nacionalidade: @produto.nacionalidade, preco: @produto.preco } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { descricao: @produto.descricao, foto: @produto.foto, marca: @produto.marca, nacionalidade: @produto.nacionalidade, preco: @produto.preco } }
